! function($, undefined) {
    ...
    var VAMTAM_ELEMENTOR = {
        ...
        pageLoaded: function() {
            this.VamtamPopupsHandler.init(), this.VamtamWidgetsHandler.FiboSearchBarWidget()
        },
        VamtamPopupsHandler: {
            init: function() {
                this.searchFormPopupsGetFocus(), this.absolutelyPositionedPopups(), this.alignedWithSelectorPopups(), this.lateInit()
            },
            lateInit: function() {
                setTimeout(() => {
            ...
            searchFormPopupsGetFocus: function() {
                window.elementorFrontendConfig.kit.vamtam_theme_search_form_popups_get_focus && elementorFrontend.elements.$window.on("elementor/popup/show", event => {
                    ...
                    if (popupHasSearchForm) {
                        ...
                        $input.focus(), $input.filter('[id^="dgwt-wcas-"]') && setTimeout(() => {
                            $input.focus()
                        }, 500)
                    }
                })
        ...
        VamtamWidgetsHandler: {
            FiboSearchBarWidget: () => {
                VAMTAM_ELEMENTOR.VamtamWidgetsHandler.isWidgetModActive("wp-widget-dgwt_wcas_ajax_search") && ($(".dgwt-wcas-suggestions-wrapp").addClass("vamtam-has-theme-widget-styles"), $(".dgwt-wcas-details-wrapp").addClass("vamtam-has-theme-widget-styles"), window.addEventListener("beforeunload", () => {
